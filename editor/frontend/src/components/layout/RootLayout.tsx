      ...
      <header className="flex items-center justify-between bg-card border-b border-border shrink-0" style={{ height: 56, paddingLeft: 28, paddingRight: 28 }}>
        ...
        {projectConfig && (
          <div className="flex items-center" style={{ gap: 10 }}>
            ...
            <button
              onClick={toggleAmbientZonesPanel}
              title="Ambient zones"
              className={[
                'flex items-center rounded-md font-medium transition-colors',
            ...
            >
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M2.5 7a4.5 4.5 0 019 0M4.5 7a2.5 2.5 0 015 0" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
                <circle cx="7" cy="7" r="1" fill="currentColor"/>
                <path d="M7 8.5v3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
              </svg>
              Ambient
            </button>
            <button
